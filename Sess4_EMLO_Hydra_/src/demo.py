...
from lightning.pytorch.loggers import Logger               #added this line for logging

from src import utils

# log = utils.get_pylogger(__name__)
#importing following lines from train.py 
...
@hydra.main(version_base="1.2", config_path="../configs", config_name="demo.yaml")
